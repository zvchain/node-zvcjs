...
zvcjs.api
  .GetTransactionByHash(
    "0x015d771f4d31ee64fb964bc163f2479b6ba15d78555e936868ad24cca55909be "
  )
  .then(res => {
    console.log(res);
  })
...
zvcjs.api
  .minerInfo(
    "zvbef13adcc9eda3514c4d8e1a11301c7ecde13d39e8d8b4bf2a9f1459b6a82923",
    "zvbef13adcc9eda3514c4d8e1a11301c7ecde13d39e8d8b4bf2a9f1459b6a82923"
  )
  .then(res => {
    console.log(res);
...
const tx = zvcjs.account.genHash({
  ...
  typ: "0",
  data:
    "JXU4RkQ5JXU5MUNDJXU2NjJGJXU4OTgxJXU1MkEwJXU1QkM2JXU3Njg0JXU1MTg1JXU1QkI5MTIzNDU2", // base64
  extra:
    "JXU4RkQ5JXU5MUNDJXU2NjJGJXU4OTgxJXU1MkEwJXU1QkM2JXU3Njg0JXU1MTg1JXU1QkI5MTIzNDU2" // base64
});
//get Signer
